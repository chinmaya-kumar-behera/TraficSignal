...
import TrafficImg from "../../assets/images/img1.png"
...
const Trafficlight = ({ id }) => {
  ...
  return (
    <SectionContainer id={id} heading="Traffic Light">
      <Paragraph>
        Traffic lights are an important part of the transportation
        infrastructure. They help to keep traffic flowing and organized.
      </Paragraph>
      <Paragraph>
        In the past, traffic lights were run by humans. They used timers and
        other tools to keep things running smoothly. However, that is no longer
        the case. Today, traffic lights are run by computers. This change was
        made in order to make things more efficient. It allows for better
        control over the timing of traffic lights.
      </Paragraph>
      <Paragraph>
      ...
      <Paragraph>
        One company that is leading this effort is called NoTraffic. It’s behind
        the new effort to make traffic lights smart. This company is trying to
        use artificial intelligence to improve traffic management.
      </Paragraph>
      <Lists list={ListData} />
      <Paragraph>
      ...
      <Image image={TrafficImg} alt={"traffic_image"}  className={'h-[400px]'}/>
    </SectionContainer>
  );
};
